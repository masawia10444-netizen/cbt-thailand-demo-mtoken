            ...
            <Grid className={classes.container} container justify='center' alignItems='flex-start'>
                <Grid item xs={8} sm={6} md={4} lg={3} container justify='flex-start' alignItems='center'>
                    <Typography variant='h2' className={classes.title}>
                        {t('REGISTER.RESET_PASSWORD.TOKEN_SUCCESS')}
                    </Typography>
                </Grid>

                <Grid item xs={12} container justify='center' alignItems='center' style={{ height: 300 }}>
                    <img loading='lazy' src={process.env.NEXT_PUBLIC_WEB_URL + '/images/icon/svg/checklist_selected.svg'} style={{ height: 150 }} alt='success' />
                </Grid>

                <Grid item xs={8} sm={6} md={4} lg={3} container justify='flex-start' alignItems='center'>
                    <Typography variant='h5' className={classes.title}>
                        {t('REGISTER.RESET_PASSWORD.DESCRIPTION_SUCCESS')}
                    </Typography>
